...
namespace MVC_proekt.Controllers
{
    public class ProfessorsController : Controller
    {
        ...
        public ProfessorsController(MVC_proektContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Professor != null ? 
                          ...
                          Problem("Entity set 'MVC_proektContext.Professor'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MVC_proektContext.Professor'  is null.");
            }
            var professor = await _context.Professor.FindAsync(id);
            if (professor != null)
            {
